...
class Mailer {
    protected $_ci;
    protected $email_sender = 'cahayactour@gmail.com'; // Isikan dengan email pengirim
    protected $sender_name = 'Pemesanan Paket - CV. Cahaya Travel'; // Isikan dengan nama pengirim
    protected $password = 'cahaya123'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        // $mail->Host = 'srv87.niagahoster.com';
        $mail->Username = $this->email_sender; // Email Pengirim
        ...
        $mail->setFrom($this->email_sender, $this->sender_name);
        $mail->addAddress($data['email_receiver'], '');
