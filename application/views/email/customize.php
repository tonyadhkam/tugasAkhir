                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10l" align="center">
                                                                                        <p style="color: #fff;" data-darkreader-inline-color>Halo <?=$name?>, Terimakasih sudah melakukan pemesanan paket customize<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <td class="esd-container-frame" width="270" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center">
                                                                                        <p><span style="font-size:16px;"><strong style="line-height: 150%;">Kode Booking : <?=$kd_booking_customize?></strong></span></p>
                                                                                        ...
                                                                                        <p><span style="font-size:16px;"><strong style="line-height: 150%;">Silahkan Transfer Rp.<?=number_format($harga)?> Ke Rekening Berikut</strong></span></p>
